...
<div";
        // line 31
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute((isset($context["attributes"]) ? $context["attributes"] : null), "addClass", array(0 => "tabs-wrapper clearfix"), "method"), "html", null, true));
        echo ">
  ";
        // line 32
...
";
    ...
    {
        return new Twig_Source("", "themes/nexus/templates/block/block--local-tasks-block.html.twig", "C:\\Users\\tiffany.hobbs\\Sites\\devdesktop\\drupal-blog-site\\themes\\nexus\\templates\\block\\block--local-tasks-block.html.twig");
    }
}
